...
if(isset($_GET['search_me']) ){

$tobesearch = $_GET['search_me'];
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="unlist" >
        ...
        <li class="nav-item">
          <a class="nav-link" href="dashboard.php" id="dashboard-link"> Dashboard</a>
        </li>

        
      </ul>
      <form class="d-flex" method="get" action="searchresults_seller.php">
        <input class="form-control me-2" id="searchbox" type="search" placeholder="Search" name="search_me" value="<?php echo $tobesearch ?>" aria-label="Search">
...
<div class="container-fluid" id="content_div" >
 <div class="row">
        <div class="col-3">  
             <p class="cat">Related search results for:  <strong><?php echo $tobesearch ?></strong></p>
        ...
        <?php
            ...
            $sql = "SELECT product_name, price,category,sub_category ,id, min(image_name) as image_name, AVG(rated_product_table.rated_points) as rate_points FROM product_table 
                    ...
                    where quantity != 0 AND product_name LIKE '%$tobesearch%' OR category LIKE '%$tobesearch%' OR sub_category LIKE '%$tobesearch%' GROUP BY product_name ORDER BY rate_points DESC;" ;
            $res  = $conn->query($sql);
...
?>
          ...
          <?php
                          if($numrows == 0){
                ?>
                    <h3>UNFORTUNATELY, THERE IS NO SEARCH RESULTS</h3>      
                    <img src="transition/undraw_Empty_re_opql.png" alt="EMPTY SEARCH RESULTS" class="img-fluid" >
