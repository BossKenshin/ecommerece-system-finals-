...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" method="get" action="searchresults_seller.php">
 ...
 <div class="row">
        <div class="col-3">
          <div class="accordion" id="accordionExample">
            ...
            <p class="cat">Results for <?php  echo $cate." ".$syb; ?></p>
              ...
              >
                <div class="accordion-body">
                  <div class="btn-group-vertical">
                    <a  href="displaycategories_seller.php?category=Men&sub=Sneakers">Sneakers</a>
                    <a  href="displaycategories_seller.php?category=Men&sub=Running Shoes">Running Shoes</a>
                    <a  href="displaycategories_seller.php?category=Men&sub=Basketball Shoes">Basketball Shoes</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              >
                <div class="accordion-body">
                  <div class="btn-group-vertical">
                   <a  href="displaycategories_seller.php?category=Women&sub=Sneakers">Sneakers</a>
                    <a  href="displaycategories_seller.php?category=Women&sub=Running Shoes">Running Shoes</a>
                    <a  href="displaycategories_seller.php?category=Women&sub=Basketball Shoes">Basketball Shoes</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              >
                <div class="accordion-body">
                  <div class="btn-group-vertical">
                   <a  href="displaycategories_seller.php?category=Kids&sub=Sneakers">Sneakers</a>
                    <a  href="displaycategories_seller.php?category=Kids&sub=Running Shoes">Running Shoes</a>
                    <a  href="displaycategories_seller.php?category=Kids&sub=Basketball Shoes">Basketball Shoes</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-9" id="product-display">
...
<?php
            ...
            $sql = "SELECT product_name, price, id, min(image_name) as image_name, AVG(rated_product_table.rated_points) as rate_points, category, sub_category FROM product_table 
                    ...
                    where quantity != 0  AND category ='$cate' AND sub_category = '$syb' GROUP BY product_name ORDER BY rate_points DESC;" ;
            $res  = $conn->query($sql);
