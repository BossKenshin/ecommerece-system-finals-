...
<div class="sum-content"> 
  <p class="prod-num"> Number of Products<br>
   <span>

   <?php 

     $selid = $_SESSION['seller_id'];
            $sql = "SELECT * FROM product_table where seller_id='$selid'  ;";
            $res  = $conn->query($sql);
...
echo $numrow;
  ...
  <button class="btn btn-outline-dark" data-toggle="modal" data-target="#ModalLoginForm" id="add-new-product">ADD NEW PRODUCT</button>

            <a class="order-history" href="orderdashboard.php" id="order"    data-toggle="tooltip" data-placement="top" title="Orders History" ><i class="bi bi-journal-text"></i></a>
 ...
 <?php
    ...
    <tr>
      ...
      <td>
          ...
          <a class = "btn btn-outline-success" href="editproduct.php ? id=<?php echo $row->id?>"><i class="bi bi-pencil-square"></i></a>
           <a class='btn btn-danger' href="deleteproduct.php ? id=<?php echo $row->id?>"><i class='bi bi-trash3'></i></a>
                ...
                <form role="form" method="POST" enctype="multipart/form-data" action="productedit.php">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group ">
                        ...
                        <div>
                            <input type="file" accept=".jpg,.jpeg,.png,.mp4" class="form-control input-lg" name="img[]" multiple = "multiple">
                        </div>
                    </div>
