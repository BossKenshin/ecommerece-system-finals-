...
<head>
    ...
    <link rel="stylesheet" href="sellehomepagestyle.css">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" method="get" action="searchresults_seller.php">
        <input class="form-control me-2" id="searchbox" type="search" name="search_me" placeholder="Search" aria-label="Search">
...
if(isset($_SESSION['add_cart_status'])){
 ...
 ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>PRODUCT IS ALREADY IN THE CART</strong> 
...
if(isset($_SESSION['checkout_status'])){
     ...
     ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                 <strong>CART CHECKOUT SUCCESSFUL</strong> 
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        <?php 
...
<?php
  ...
  <div class="product-div">
               <a  href="viewproduct.php?id=<?php echo $row->id;?>" class="view-product"></a>
